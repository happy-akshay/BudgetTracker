    ...
    <>
      <div className="flex flex-wrap sm:flex-nowrap gap-2">
        <StatCard
          ...
          title="Income"
          Icon={
            <TrendingUp className="h-16 w-16 rounded-[20%] bg-emerald-400 border-[1px] text-white" />
          }
        />
        <StatCard
          formmatter={formMatter}
          ...
          title="Expense"
          Icon={
            <TrendingDownIcon className="h-16 w-16 rounded-[20%] bg-red-400 border-[1px] text-white" />
          }
        />
        <StatCard
          formmatter={formMatter}
          ...
          title="Balance"
          Icon={
            <PiggyBank className="h-16 w-16 rounded-[20%] bg-[#F3721B] border-[1px] text-white" />
          }
        />
      </div>
    </>
